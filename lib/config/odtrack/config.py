...
cfg.MODEL.MOTION.USE_TIME_AWARENESS = True
cfg.MODEL.MOTION.TIME_EMBEDDING_DIM = 128
# MODIFICATION END
...
# MODIFICATION START
cfg.TRAIN.MOTION_WEIGHT = 1.0
cfg.TRAIN.USE_TIME_AWARE_LOSS = True
cfg.TRAIN.MOTION_LOSS_DECAY_RATE = 0.01  # Alpha for exp(-alpha * (dt - 1))
# MODIFICATION END
